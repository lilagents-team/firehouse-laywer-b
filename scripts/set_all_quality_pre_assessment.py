...
def set_all_metadata_quality_to_pre_assessment():
    """Set all newsletter markdown files' metadata_quality field to 'pre-assessment'."""
        ...
        try:
            ...
            if re.search(r'^metadata_quality:', frontmatter, re.MULTILINE):
                ...
                new_frontmatter = re.sub(
                    r'^metadata_quality:.*$', 
                    'metadata_quality: "pre-assessment"', 
                    frontmatter, 
                    flags=re.MULTILINE
                )
...
if __name__ == "__main__":
    set_all_metadata_quality_to_pre_assessment()